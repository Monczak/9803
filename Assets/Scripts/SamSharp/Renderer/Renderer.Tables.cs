namespace SamSharp.Renderer
{
    public partial class Renderer
    {
        ...
        // Stress pitch table
        private readonly int[] stressPitch_tab47492 = { 0x00, 0xE0, 0xE6, 0xEC, 0xF3, 0xF9, 0x00, 0x06, 0x0C, 0x06 };
        ...
        private readonly int[] frequencyData =
        {
            ...
            0x000013 | 0x007F00 | 0x010000, // 'UN' 80
            0x000000 | 0x000000 | 0x000000, // '#*' 81
        };
        ...
        private readonly int[] amplitudeData =
        {
            ...
            0x00000F | 0x000000 | 0x100000, // 'UN' 80
            0x000000 | 0x000000 | 0x000000, // '#*' 81
        };
